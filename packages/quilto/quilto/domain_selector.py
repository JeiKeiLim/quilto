...
class DomainSelector:
    ...
    def __init__(self, domains: Sequence[DomainModule]) -> None:
        """Initialize DomainSelector with available domains.
    ...
    def build_active_context(self, selected_domains: list[str]) -> ActiveDomainContext:
        ...
        Returns:
            ActiveDomainContext with merged data from selected domains.
        """
        selected = [
