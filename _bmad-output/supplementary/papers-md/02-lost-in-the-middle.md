...
**Source:** `02-lost-in-the-middle.pdf`
...
|Total|Col2|Ret|rieved Documents (~4K token|Col5|Col6|Col7|
|---|---|---|---|---|---|---|
||||||||
||||||||
||||||||
...
only marginally improves performance ( _∼_ 1.5% for
...
_exactly one_ of the documents contains the answer
...
2 Ambiguity in NaturalQuestions-Open means that a small
...
Appendix A.
3 We also explored using random documents as distractors,
see Appendix B for more details.
4 Since there might be a prior over “search results” appearing in ranked order, we explored randomly ordering the _k −_ 1
...
6 We also evaluate GPT-4 (8K) on a subset of multidocument QA experiments, finding similar results and trends
...
|Tota|Col2|l Ret|rieved Documents (~4K token|Col5|Col6|Col7|
|---|---|---|---|---|---|---|
||||||||
||||||||
||||||||
...
of long-range transformers. In _Proc. of EACL_ .


Colin Raffel, Noam Shazeer, Adam Roberts,
Katherine Lee, Sharan Narang, Michael Matena,
Yanqi Zhou, Wei Li, and Peter J. Liu. 2020. Exploring the limits of transfer learning with a unified text-to-text Transformer. _Journal of Ma-_
_chine Learning Research_, 21(140):1–67.


Ori Ram, Yoav Levine, Itay Dalmedigos, Dor
Muhlgay, Amnon Shashua, Kevin LeytonBrown, and Yoav Shoham. 2023. Incontext retrieval-augmented language models.
ArXiv:2302.00083.
...
history effectively? an empirical study. In _Proc._
_of ACL_ .
...
|(~4K tokens, unambi|Col2|Col3|Col4|guous ques|Col6|tions)|
|---|---|---|---|---|---|---|
||||||||
||||||||
||||||||
...
|(~4K tokens,|Col2|randomly|Col4|order|ed)|
|---|---|---|---|---|---|
|||||||
|||||||
|||||||
...
|(~4K tokens, 500 questi|Col2|Col3|on sampl|e)|
|---|---|---|---|---|
||||||
||||||
||||||
...
occurs at position _n_ + 1, where lower indices are closer to the start of the input context. For example,
